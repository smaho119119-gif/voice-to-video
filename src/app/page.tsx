                    ...
                    <AnimatedSection>
                        ...
                        >
                            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 border border-white/20 mb-8">
                                ...
                                <span className="text-sm text-slate-300">YouTube Shorts・TikTok・Reels向け動画を自動作成</span>
                            </div>
                        </motion.div>
                        ...
                        >
                            「睡眠の質を上げる方法」などテーマを入力 → AIが台本を作成 →
                            画像・ナレーション・字幕を自動生成 → 完成した動画をダウンロード。
                            <span className="text-white font-medium">編集スキル不要、最短1分で完成。</span>
                        </motion.p>
            ...
            <section className="h-screen w-full snap-start flex items-center justify-center relative bg-slate-950/50">
                <div className="max-w-6xl mx-auto px-4 w-full">
                    <AnimatedSection className="text-center mb-12">
                        <h2 className="text-4xl font-bold mb-4">4つのAIが連携して動画を自動生成</h2>
                        <p className="text-slate-400 max-w-2xl mx-auto">
                            Premiere ProやAfter Effectsは不要。テーマを入力するだけで、
                            4つのAIが連携して高品質な縦型動画を自動で作成します。
                        </p>
                    </AnimatedSection>
            ...
            <section className="h-screen w-full snap-start flex items-center justify-center bg-gradient-to-b from-transparent via-blue-950/20 to-transparent">
                <div className="max-w-6xl mx-auto px-4 w-full">
                    <AnimatedSection className="text-center mb-16">
                        ...
                        <p className="text-slate-400">動画編集ソフトは一切不要。テーマを入力して待つだけ。</p>
                    </AnimatedSection>
            ...
            <section className="h-screen w-full snap-start flex items-center justify-center">
                <div className="max-w-6xl mx-auto px-4 w-full">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center mb-24">
                        {[
                            { value: "1分〜", label: "動画生成時間", icon: Clock },
                            { value: "1080p", label: "縦型HD画質", icon: Zap },
                            { value: "8+", label: "AI音声バリエーション", icon: Mic },
                            { value: "無制限", label: "ローカル生成", icon: Sparkles }
                        ].map((stat, i) => (
                        ...
                        <AnimatedSection>
                            <div className="relative p-12 rounded-3xl bg-gradient-to-br from-blue-600/20 to-purple-600/20 border border-white/10 overflow-hidden">
                                <div className="relative z-10">
                                    <h2 className="text-4xl md:text-5xl font-bold mb-6">今すぐ動画を作ろう</h2>
                                    <p className="text-slate-300 mb-10 max-w-xl mx-auto text-lg">
                                        テーマを入力 → 台本・画像・音声・字幕を自動生成 → MP4ダウンロード。
                                        編集スキル不要で、ショート動画の量産体制が整います。
                                    </p>
                                    <Link href="/login">
